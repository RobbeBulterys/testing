...
namespace BL_Projectwerk.Domein {
    public class Werknemercontract {
        ...
        private void ZetBedrijfEnWerknemer(Bedrijf bedrijf, Werknemer werknemer) {
            ...
            if (werknemer == null) { throw new WerknemercontractException("Werknemercontract - ZetWerknemer - werknemer is null"); }
            if (bedrijf == null) { throw new WerknemercontractException("Werknemercontract - ZetBedrijf - bedrijf is null"); }
            ...
            //werknemer.VoegContractToe(this);
            //Bedrijf.VoegWerknemerToe(werknemer); // We verwachten dat werknemer een contract heeft met dit bedrijf
        ...
        public void ZetFunctie(string functie) {
            if (string.IsNullOrWhiteSpace(functie)) { throw new WerknemerException("Werknemercontract - ZetFunctie - geen functie ingevuld"); }
            Functie = functie.Trim();
        }

        internal bool IsDezelfde(Werknemercontract update) {
