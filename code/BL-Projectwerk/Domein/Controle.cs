...
namespace BL_Projectwerk.Domein
{
    public class Controle
    {
        ...
        {
            if (string.IsNullOrWhiteSpace(BtwNummer)) { throw new ControleException("Controle - IsBestaandBTWnummer - geen BTWNummer ingevuld"); } //TODO : Regex controle geldigheid NL898219504B68 geeft foutmeldig maar zou goede syntax zijn.
        ...
        public static bool IsGoedeAdresNummerSyntax(string nummer)
        {
            ...
            if (!nummer.Any(c => char.IsDigit(c))) { throw new ControleException("Controle - IsGoedeAdresNummerSyntax - geen geldige nummer ingevuld"); }
